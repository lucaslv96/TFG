...
class Ui_AyudaWindow(object):
    def setupUi(self, AyudaWindow, tab_name):
        ...
        AyudaWindow.resize(800, 600)  # Altura aumentada para mejor apariencia
        
        # Establecer un estilo y hoja de estilos más agradable para la aplicación
        ...
        self.verticalLayout.setContentsMargins(20, 20, 20, 20)  # Añadir más espacio
        
        self.tabWidget = QtWidgets.QTabWidget(AyudaWindow)
        self.tabWidget.setObjectName("tabWidget")
        
        # Mejorar el diseño de la pestaña "Acerca de" con mejor espaciado y estilo
        self.tab_acerca_de = QtWidgets.QWidget()
        self.tab_acerca_de.setObjectName("tab_acerca_de")
        
        # Crear un mejor layout para la página "Acerca de"
        ...
        # Crear la sección superior con el icono y el título de la aplicación
        ...
        if os.path.exists(icon_path):
            ...
            # Crear un marcador de posición o un logo de texto si el icono no existe
        ...
        # Añadir la sección de título y versión
        ...
        # Crear un QScrollArea para la sección de descripción
        self.scroll_area = QtWidgets.QScrollArea(self.tab_acerca_de)
        self.scroll_area.setWidgetResizable(True)
        self.scroll_area.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.scroll_area.setStyleSheet("background-color: transparent;")
        
        # Crear un widget para contener el contenido del área de scroll
        self.scroll_content = QtWidgets.QWidget()
        self.scroll_layout = QtWidgets.QVBoxLayout(self.scroll_content)
        self.scroll_layout.setContentsMargins(0, 0, 0, 0)
        self.scroll_layout.setSpacing(10)
        
        # Sección de descripción - ahora dentro del área de scroll
        ...
        # Sección de características - también dentro del área de scroll
        ...
        # Añadir stretch para empujar el contenido hacia arriba
        self.scroll_layout.addStretch()
        
        # Establecer el widget de contenido en el área de scroll
        self.scroll_area.setWidget(self.scroll_content)
        
        # Añadir el área de scroll al layout principal
        self.acerca_de_layout.addWidget(self.scroll_area, 1)  # Factor de estiramiento 1
        
        # Secciones de autor y copyright eliminadas según lo solicitado
        ...
        self.verticalLayout_guia_rapida.setContentsMargins(20, 20, 20, 20)  # Añadir más espacio
        ...
        # Sección de capturas de pantalla eliminada según lo solicitado
        
        # Añadir stretch al final para empujar el contenido hacia arriba
        ...
        self.verticalLayout_autor.setContentsMargins(20, 20, 20, 20)  # Añadir más espacio
        ...
        self.verticalLayout_documentacion.setContentsMargins(20, 20, 20, 20)  # Añadir más espacio
        ...
        # Aplicar fuente en negrita al texto de las pestañas
        for i in range(self.tabWidget.count()):
            tab_font = QtGui.QFont()
            tab_font.setBold(True)
            tab_font.setPointSize(10)  # Tamaño de fuente más grande
            self.tabWidget.tabBar().setTabTextColor(i, QtGui.QColor("#2c3e50"))  # Color de texto más oscuro
        ...
        # Mostrar la pestaña adecuada y gestionar la visibilidad según el parámetro tab_name
        if tab_name == 'acerca_de':
            self.tabWidget.setCurrentIndex(0)
            AyudaWindow.resize(800, 600)  # Mejor tamaño para la pestaña "Acerca de"
        elif tab_name == 'documentacion':
            self.tabWidget.setCurrentIndex(3)
            AyudaWindow.resize(900, 700)  # Tamaño más grande para la documentación
