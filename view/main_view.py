...
from controller.datos_equivalentes_controller import mostrar_datos_equivalentes, show_chart
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setFixedSize(110, 30)  # Adjust size for better readability
        self.pushButton.setStyleSheet("padding: 5px;")  # Add padding for better readability
        ...
        self.search_google.setVisible(True)  # Initially hidden
        ...
        self.search_yahoo.setVisible(True)  # Initially hidden
        ...
        self.search_macrotrends.setVisible(True)  # Initially hidden
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_income_statement.setText(_translate("MainWindow", "Datos de Estado de Resultados"))
