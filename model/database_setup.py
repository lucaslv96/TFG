...
def initialize_database():
    ...
    if not os.path.exists(db_filename):
        ...
        # Cargar datos desde data_filter.py
        load_data(cursor)
...
def load_data(cursor):
    ...
    # Yahoo Finance: ejemplo con ticker AAPL
    yahoo_income_data = filtrar_datos_yahoo('AAPL', 'income')
    ...
    # Insertar datos en la tabla google_finance
    ...
    # Insertar datos en la tabla yahoo_finance
    ...
    # Insertar datos en la tabla macrotrends
    ...
    # Insertar valores por defecto en la tabla equivalencias
